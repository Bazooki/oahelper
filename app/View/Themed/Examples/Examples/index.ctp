...
<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
    <div class="container">
        <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" data-0="line-height:90px;" data-300="line-height:50px;">Amoeba                </a></h1>
        </div>
        ...
        <div class="row align-center mar-bot40">
            <div class="col-md-3">
                <div class="team-member">
                    <figure class="member-photo"><?php echo $this->Html->image('team/member1.jpg')?></figure>
            ...
            <div class="col-md-3">
                <div class="team-member">
                    <figure class="member-photo"><?php echo $this->Html->image('team/member2.jpg')?></figure>
                    <div class="team-detail">
                        <h4>Timothy Clark</h4>
            ...
            <div class="col-md-3">
                <div class="team-member">
                    <figure class="member-photo"><?php echo $this->Html->image('team/member3.jpg')?></figure>
                    <div class="team-detail">
                        <h4>Vicky Tan</h4>
            ...
            <div class="col-md-3">
                <div class="team-member">
                    <figure class="member-photo"><?php echo $this->Html->image('team/member4.jpg')?></figure>
                    <div class="team-detail">
                    ...
                    <div class="portfolio-items isotopeWrapper clearfix" id="3">
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img1.jpg')?>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img2.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img3.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img4.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img5.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img6.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img7.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img8.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <?php echo $this->Html->image('portfolio/img9.jpg')?>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                                        <h5><a href="#">Portfolio name</a></h5>
